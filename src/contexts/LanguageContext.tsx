...
const translations = {
  en: {
    ...
    accreditationStandardsDesc: 'As a non-charter private school, we maintain high educational standards while providing the flexibility to integrate Islamic education throughout our curriculum. Our programs meet and exceed state educational requirements.',
    ...
    requiredFields: 'Required fields. By submitting this form, you agree to be contacted by Al-Quran Islamic School regarding your application.',
...
>>>>>>> 341fb1ce0eac1f663a0467c3513147e554399122
  ru: {
    // Navigation
    home: 'Главная',
    about: 'О нас',
    ...
    accreditationStandardsDesc: 'Как частная школа без устава, мы поддерживаем высокие образовательные стандарты, обеспечивая гибкость для интеграции исламского образования в нашу учебную программу. Наши программы соответствуют государственным образовательным требованиям и превосходят их.',
    ...
    requiredFields: 'Обязательные поля. Отправляя эту форму, вы соглашаетесь, чтобы с вами связались представители Исламской школы Аль-Коран по поводу вашей заявки.',
